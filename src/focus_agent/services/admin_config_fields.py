...
_POLICY_FIELD_SPECS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        "Agent Team v2",
        "boolean",
        "Enable the guarded Agent Team v2 rollout surface.",
    ),
    ConfigFieldSpec(
        "agent_team_rollout_phase",
        "AGENT_TEAM_ROLLOUT_PHASE",
        "Agent Team rollout",
        "string",
        "Rollout phase for Agent Team v2; execution remains disabled by default.",
        ("off", "shadow", "canary", "enabled"),
    ),
    ConfigFieldSpec(
        "agent_team_execution_mode",
        "AGENT_TEAM_EXECUTION_MODE",
        "Agent Team execution",
        "string",
        "Explicit execution mode for Agent Team v2.",
        ("disabled", "inline", "background", "worktree_sandbox"),
    ),
    ConfigFieldSpec(
        "agent_team_real_provider_enabled",
        "AGENT_TEAM_REAL_PROVIDER_ENABLED",
        "Agent Team real provider",
        "boolean",
        "Allow Agent Team v2 to use a configured real model provider.",
    ),
    ConfigFieldSpec(
        "agent_team_durable_required",
        "AGENT_TEAM_DURABLE_REQUIRED",
        "Agent Team durable required",
        "boolean",
        "Require durable Postgres-backed execution before real Agent Team runs.",
    ),
    ConfigFieldSpec(
        ...
        "Agent Team fencing",
        "boolean",
        "Require fencing-capable resource coordination for real Agent Team runs.",
    ),
    ConfigFieldSpec(
        "agent_team_approval_resume_enabled",
        "AGENT_TEAM_APPROVAL_RESUME_ENABLED",
        "Agent Team approval resume",
        "boolean",
        "Declare that approved Agent Team work must use an explicit resumable path.",
    ),
    ConfigFieldSpec(
        "agent_team_cross_session_locks_enabled",
        "AGENT_TEAM_CROSS_SESSION_LOCKS_ENABLED",
        "Agent Team cross-session locks",
        "boolean",
        "Require cross-session resource locks for real Agent Team runs.",
    ),
    ConfigFieldSpec(
        "agent_team_kill_switch_enabled",
        "AGENT_TEAM_KILL_SWITCH_ENABLED",
        "Agent Team kill switch",
        "boolean",
        "Keep the Agent Team v2 execution kill switch armed.",
    ),
    ConfigFieldSpec(
        "agent_team_legacy_write_enabled",
        "AGENT_TEAM_LEGACY_WRITE_ENABLED",
        "Agent Team legacy writes",
        "boolean",
        "Allow legacy Agent Team endpoints to perform writes.",
    ),
    ConfigFieldSpec(
        "agent_team_global_tab_enabled",
        "AGENT_TEAM_GLOBAL_TAB_ENABLED",
        "Agent Team global tab",
        "boolean",
        "Expose Agent Team v2 through the global navigation surface.",
    ),
    ConfigFieldSpec(
        ...
        "Agent Team adoption",
        "boolean",
        "Allow adoption workflows for Agent Team v2 outputs.",
    ),
    ConfigFieldSpec(
