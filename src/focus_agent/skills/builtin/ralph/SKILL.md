...
recommended_tools: git_status, git_diff, search_code, read_file, git_log, apply_patch, run_workspace_command
prompt_mode: execute
---
# Ralph
...
- Use approved `apply_patch` edits and `run_workspace_command` checks when the task calls for code changes or verification.
