...
recommended_tools: list_files, search_code, read_file, apply_patch, run_workspace_command, git_status, git_diff, write_text_artifact, artifact_read, artifact_update, memory_search, memory_save
prompt_mode: execute
---
# Autopilot
...
- Apply code changes with `apply_patch` after approval, then verify the result with the narrowest relevant `run_workspace_command`.
