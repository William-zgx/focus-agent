...
recommended_tools: list_files, search_code, read_file, apply_patch, run_workspace_command, git_status, git_diff, write_text_artifact
prompt_mode: execute
---
# TDD
...
- Use `apply_patch` for the implementation change after approval, then use `run_workspace_command` for the focused test or check.
