...
def create_app() -> FastAPI:
    ...
    @app.post('/v1/agent-team/sessions', response_model=AgentTeamSessionResponse)
    ...
    @app.get('/v1/agent-team/sessions', response_model=AgentTeamSessionListResponse)
    ...
    @app.get('/v1/agent-team/sessions/{session_id}', response_model=AgentTeamSessionResponse)
    ...
    @app.post('/v1/agent-team/sessions/{session_id}/dispatch', response_model=AgentTeamDispatchResponse)
    ...
    @app.post('/v1/agent-team/sessions/{session_id}/tasks', response_model=AgentTeamTaskResponse)
    ...
    @app.get('/v1/agent-team/sessions/{session_id}/tasks', response_model=AgentTeamTaskListResponse)
    ...
    @app.get('/v1/agent-team/tasks/{task_id}', response_model=AgentTeamTaskResponse)
    ...
    @app.patch('/v1/agent-team/tasks/{task_id}', response_model=AgentTeamTaskResponse)
    @app.post('/v1/agent-team/tasks/{task_id}/status', response_model=AgentTeamTaskResponse)
    ...
    @app.post('/v1/agent-team/tasks/{task_id}/outputs', response_model=AgentTeamTaskOutputResponse)
    ...
    @app.post('/v1/agent-team/sessions/{session_id}/merge-bundle', response_model=AgentTeamMergeBundleResponse)
    @app.post('/v1/agent-team/sessions/{session_id}/merge-proposal', response_model=AgentTeamMergeBundleResponse)
    ...
    @app.post('/v1/agent-team/sessions/{session_id}/merge-decision', response_model=AgentTeamMergeDecisionResponse)
    @app.post('/v1/agent-team/sessions/{session_id}/merge', response_model=AgentTeamMergeDecisionResponse)
