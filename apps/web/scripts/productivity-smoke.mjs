...
const files = {
	...
	shellConfig: readFileSync(
		resolve(appRoot, "src/app/shell/app-shell-config.ts"),
		"utf8",
	),
...
const expectations = [
	...
	},
	{
		...
		pass:
			files.router.includes('<LazyProductivityPage mode="notes" />') &&
			files.router.includes('<LazyProductivityPage mode="tasks" />'),
	},
	{
