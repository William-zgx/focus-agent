...
type BranchTreeNodeRendererProps = {
  ...
  onRequestDetail: (node: BranchTreeNode, anchorElement: HTMLElement | null) => void;
...
export function BranchTreeNodeRenderer({
  ...
  function shouldKeepDetailOpen(relatedTarget: EventTarget | null) {
    return relatedTarget instanceof Node && detailOverlayRef.current?.contains(relatedTarget);
  }
