...
export function roleLabel(role: BranchTreeNode["branch_role"], isChineseUi = false) {
  switch (role) {
    case "deep_dive":
...
export function branchStatusLabel(status: BranchTreeNode["branch_status"], isChineseUi = false) {
