// biome-ignore-all lint/a11y/useSemanticElements: Model options contain nested thinking-mode controls.
		...
		<div className="fa-composer-model-anchor fa-composer-model-shell">
			...
			>
				<span className="fa-composer-model-trigger-copy">
					...
					/>
					<span className="fa-composer-model-trigger-label">
						{activeModelLabel}
					</span>
					<span className="fa-composer-model-trigger-provider">
						{activeModelProvider}
					</span>
				</span>
										...
										return (
											...
											>
												...
												<div className="fa-composer-model-option-trailing">
													...
													<span
														className="fa-composer-model-check"
														aria-hidden="true"
													>
														✓
													</span>
