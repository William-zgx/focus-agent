...
export function AccountSecurityPage() {
  ...
  const [submitting, setSubmitting] = useState<"password" | "logout" | null>(null);
  const canSubmit = currentPassword && newPassword && newPassword === confirmPassword && submitting === null;
      ...
      <section className="fa-account-panel">
        ...
        <form className="fa-auth-form" onSubmit={handleChangePassword}>
          ...
          <div className="fa-auth-actions">
            ...
            <button className="fa-auth-button" disabled={Boolean(submitting)} onClick={handleLogout} type="button">
