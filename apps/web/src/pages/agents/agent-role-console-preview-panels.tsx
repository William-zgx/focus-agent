    ...
    <div className="fa-observability-detail-panel fa-agent-role-panel">
      ...
      <div className="fa-agent-role-dry-run-form">
        ...
        <label className="fa-observability-filter fa-agent-role-field">
          ...
          <input value={availableTools} onChange={(event) => onAvailableToolsChange(event.target.value)} />
        </label>
    ...
    <div className="fa-observability-detail-panel fa-agent-role-panel">
      ...
      <div className="fa-agent-role-dry-run-form">
        <label className="fa-observability-filter fa-agent-role-field">
          ...
          <select value={toolRouteRole} onChange={(event) => onToolRouteRoleChange(event.target.value)}>
        ...
        <label className="fa-observability-filter fa-agent-role-field">
          ...
          <select value={toolRoutePolicy} onChange={(event) => onToolRoutePolicyChange(event.target.value)}>
