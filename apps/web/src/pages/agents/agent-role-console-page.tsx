...
import { useAgentRoleConsolePreviews, useAgentRoleConsoleQueries } from "./agent-role-console-view-model";
...
export function AgentRoleConsolePage() {
  ...
  const recentDelegatedArtifacts = previews.taskLedgerPreview.data?.artifacts ?? queries.recentDelegatedArtifacts;

  return (
    <div className="fa-observability-layout fa-agent-role-console">
      <AgentRoleHero
        artifactizeLongObservations={queries.contextPolicy.data?.artifactize_long_observations}
      ...
      <DelegationModelRouterPanels
        delegationTrajectoryAvailable={queries.delegationRuns.data?.trajectory_available}
        isChineseUi={isChineseUi}
      ...
      <section className="fa-agent-role-grid">
        <TaskLedgerPanel
          ...
          taskLedgerTrajectoryAvailable={queries.taskLedgerRuns.data?.trajectory_available}
        />
        <DelegatedArtifactsPanel
          delegatedArtifactsTrajectoryAvailable={queries.delegatedArtifacts.data?.trajectory_available}
          isChineseUi={isChineseUi}
      ...
      <CriticGatePanel
        criticTrajectoryAvailable={queries.criticVerdicts.data?.trajectory_available}
      ...
      <RepairReviewQueuePanels
        ...
        reviewQueueTrajectoryAvailable={queries.reviewQueue.data?.trajectory_available}
        selfRepairTrajectoryAvailable={queries.selfRepairFailures.data?.trajectory_available}
      />
      ...
      <section className="fa-agent-role-grid">
        ...
        />
        <ContextArtifactsPanel
          contextArtifactsTrajectoryAvailable={queries.contextArtifacts.data?.trajectory_available}
          isChineseUi={isChineseUi}
      ...
      <ContextDecisionsPanel
        ...
        contextDecisionsTrajectoryAvailable={queries.contextDecisions.data?.trajectory_available}
        isChineseUi={isChineseUi}
      ...
      <ToolRouterTrajectoryPanel
        ...
        toolRouteTrajectoryAvailable={queries.toolRouteDecisions.data?.trajectory_available}
      />

      <RecentDecisionRecordsPanel
        decisionCount={queries.decisions.data?.count}
        decisionsTrajectoryAvailable={queries.decisions.data?.trajectory_available}
