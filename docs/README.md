...
- [memory-system-v2.md](memory-system-v2.md)：PostgreSQL canonical memory、Zvec-first 检索接入、namespace、写入、审计、forget、branch promotion 和 legacy fallback / migration 背景。
