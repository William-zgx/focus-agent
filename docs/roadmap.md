...
| Model Routing | v2 dry-run、API/SDK/Web 控制台、行为边界与 eval gate 已补，legacy 执行路径保持不变 | [agent-role-routing.md](agent-role-routing.md) `tests/eval/datasets/agent_arch.jsonl` `/app/agent/roles` | 从 dry-run 进入受控 delegation、成本路由与 helper fallback 观测 |
